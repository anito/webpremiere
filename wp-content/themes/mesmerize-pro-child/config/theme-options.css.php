...
.l-header .widget {
	...
	font-size: <?php echo us_get_option( 'body_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'body_lineheight' ) ?>;
	}
...
h1 {
	font-size: <?php echo us_get_option( 'h1_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'h1_lineheight' ) ?>;
	font-weight: <?php echo us_get_option( 'h1_fontweight' ) ?>;
	letter-spacing: <?php echo us_get_option( 'h1_letterspacing' ) ?>;
...
h2 {
	font-size: <?php echo us_get_option( 'h2_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'h2_lineheight' ) ?>;
	font-weight: <?php echo us_get_option( 'h2_fontweight' ) ?>;
	letter-spacing: <?php echo us_get_option( 'h2_letterspacing' ) ?>;
...
h3 {
	font-size: <?php echo us_get_option( 'h3_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'h3_lineheight' ) ?>;
	font-weight: <?php echo us_get_option( 'h3_fontweight' ) ?>;
	letter-spacing: <?php echo us_get_option( 'h3_letterspacing' ) ?>;
...
.widgettitle,
.comment-reply-title {
	font-size: <?php echo us_get_option( 'h4_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'h4_lineheight' ) ?>;
	font-weight: <?php echo us_get_option( 'h4_fontweight' ) ?>;
	letter-spacing: <?php echo us_get_option( 'h4_letterspacing' ) ?>;
...
h5 {
	font-size: <?php echo us_get_option( 'h5_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'h5_lineheight' ) ?>;
	font-weight: <?php echo us_get_option( 'h5_fontweight' ) ?>;
	letter-spacing: <?php echo us_get_option( 'h5_letterspacing' ) ?>;
...
h6 {
	font-size: <?php echo us_get_option( 'h6_fontsize' ) ?>;
	line-height: <?php echo us_get_option( 'h6_lineheight' ) ?>;
	font-weight: <?php echo us_get_option( 'h6_fontweight' ) ?>;
	letter-spacing: <?php echo us_get_option( 'h6_letterspacing' ) ?>;
...
input[type="submit"] {
	...
	if ( $btn_styles[0]['font'] != 'body' ) {
		echo us_get_font_css( $btn_styles[0]['font'], FALSE );
	}
	?>
	...
	box-shadow: 0 <?php echo floatval( $btn_styles[0]['shadow'] ) / 2 ?>em <?php echo $btn_styles[0]['shadow'] ?> rgba(0,0,0,0.2);
...
.no-touch input[type="submit"]:hover {
	box-shadow: 0 <?php echo floatval( $btn_styles[0]['shadow_hover'] ) / 2 ?>em <?php echo $btn_styles[0]['shadow_hover'] ?> rgba(0,0,0,0.2);
...
foreach ( $btn_styles as $btn_style ) {
	...
	.us-btn-style_<?php echo $btn_style['id'] ?> {
		...
		echo us_get_font_css( $btn_style['font'], FALSE );
		?>
		...
		box-shadow: <?php echo ( ! empty( $btn_style['shadow'] ) ) ? ( '0 ' . floatval( $btn_style['shadow'] ) / 2 . 'em ' . $btn_style['shadow'] . ' rgba(0,0,0,0.2)' ) : 'none' ?>;
		}
	...
	.no-touch .us-btn-style_<?php echo $btn_style['id'] ?>:hover {
		...
		?>
		box-shadow: 0 <?php echo floatval( $btn_style['shadow_hover'] ) / 2 ?>em <?php echo $btn_style['shadow_hover'] ?> rgba(0,0,0,0.2);
