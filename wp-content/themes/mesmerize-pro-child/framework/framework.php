...
$us_stylesheet_directory = $us_template_directory = get_stylesheet_directory();
$us_stylesheet_directory_uri = $us_template_directory_uri = get_stylesheet_directory_uri();
...
if ( is_admin() ) {
	...
	if ( $remove_protocol ) {
		$us_template_directory_uri = str_replace( array( 'http:', 'https:' ), '', get_stylesheet_directory_uri() );
