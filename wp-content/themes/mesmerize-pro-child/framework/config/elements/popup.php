...
return array(
	...
	'params' => array_merge( array(
		...
		'trigger_selector' => array(
			...
			'description' => __( 'Use class or ID.', 'us' ) . ' ' . sprintf( __( 'Examples: %s', 'us' ), '<span class="usof-example">.my-element</span>, <span class="usof-example">#my-element</span>' ),
			'type' => 'text',
			'std' => '.my-element',
