...
return array(
	...
	'params' => array_merge( array(
		...
		'height' => array(
			'description' => sprintf( __( 'Examples: %s', 'us' ), '<span class="usof-example">30px</span>, <span class="usof-example">2rem</span>, <span class="usof-example">5vh</span>' ),
			'type' => 'text',
			'std' => '',
			'holder' => 'div',
		...
		'breakpoint_1_height' => array(
			'title' => us_translate( 'Height' ),
			'description' => sprintf( __( 'Examples: %s', 'us' ), '<span class="usof-example">10px</span>, <span class="usof-example">1rem</span>, <span class="usof-example">3vh</span>' ),
			'type' => 'text',
			'std' => '',
			'cols' => 2,
			'group' => us_translate( 'Responsive Options', 'js_composer' ),
