	...
	'general' => array(
		...
		'fields' => array(
			...
			'back_to_top' => array(
				...
				'type' => 'switch',
				'switch_text' => __( 'Enable button which allows scroll a page back to the top', 'us' ),
				'std' => 1,
			),
	...
	'layout' => array(
		...
		'fields' => array(
			...
			'columns_stacking_width' => array(
				...
				'type' => 'slider',
				'std' => '768px',
				'only_number' => TRUE, // save and return only numeric value without units
				'options' => array(
					'px' => array(
						'min' => 768,
						'max' => 1025,
			...
			'buttons' => array(
				...
				'params' => array(
					...
					'color_bg' => array(
						...
						'switch_text' => us_translate( 'Background' ),
						'classes' => 'cols_2',
					),
					...
					'color_border' => array(
						'type' => 'color',
						'std' => '',
						'switch_text' => us_translate( 'Border' ),
						'classes' => 'cols_2',
					),
	...
	'portfolio' => array(
		...
		'fields' => array(
			...
			'portfolio_comments' => array(
				...
				'type' => 'switch',
				'switch_text' => __( 'Enable comments for Portfolio Pages', 'us' ),
				'std' => 0,
			),
			'portfolio_nav' => array(
				'title' => __( 'Prev/Next Navigation', 'us' ),
				'type' => 'switch',
				'switch_text' => __( 'Show previous/next portfolio pages on sides of the screen', 'us' ),
				'std' => 1,
			),
			...
			'portfolio_nav_category' => array(
				'type' => 'switch',
				'switch_text' => __( 'Navigate within a category', 'us' ),
				'std' => 0,
				'classes' => 'for_above',
				'show_if' => array( 'portfolio_nav', '=', TRUE ),
			),
	...
	'blog' => array(
		...
		'fields' => array(
			...
			'cpt_as_posts' => array(
				...
				'classes' => ( count( $public_cpt_for_posts ) == 0 ) ? 'hidden' : '',
				'std' => array(),
			),
			...
			'post_sharing' => array(
				...
				'type' => 'switch',
				'switch_text' => __( 'Show block with sharing buttons', 'us' ),
				'std' => 0,
			),
			...
			'post_author_box' => array(
				...
				'type' => 'switch',
				'switch_text' => __( 'Show block with information about post author', 'us' ),
				'std' => 0,
			),
			'post_nav' => array(
				'title' => __( 'Prev/Next Navigation', 'us' ),
				'type' => 'switch',
				'switch_text' => __( 'Show links to previous/next posts', 'us' ),
				'std' => 0,
			),
			...
			'post_related' => array(
				...
				'type' => 'switch',
				'switch_text' => __( 'Show list of similar posts', 'us' ),
				'std' => 0,
			),
