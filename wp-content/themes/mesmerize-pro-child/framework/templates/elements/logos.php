...
if ( isset( $atts['with_indents'] ) AND $atts['with_indents'] ) {
...
$output = '<div class="w-logos' . $classes . '"' . $el_id . '><div class="w-logos-list' . $list_classes . '">';
if ( empty( $atts['items'] ) ) {
	$atts['items'] = array();
} else {
