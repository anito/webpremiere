...
$title = isset( $title ) ? $title : us_translate( 'Submit' );
...
if ( ! empty( $btn_size_mobiles ) ) {
	...
	$inline_style .= '<style>@media(max-width:600px){.us_form_' . $us_form_index . ' .w-btn{font-size:' . $btn_size_mobiles . '!important}}</style>';
}
