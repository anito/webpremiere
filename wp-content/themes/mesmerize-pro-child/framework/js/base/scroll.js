...
!function($){
	...
	function USScroll(options){
		...
		var defaults = {
			 ...
			 */
			attachOnInit: '.menu-item a[href*="#"], .menu-item[href*="#"], a.w-btn[href*="#"], .w-iconbox a[href*="#"], .w-image a[href*="#"], .w-text a[href*="#"], ' +
				'.vc_icon_element a[href*="#"], .vc_custom_heading a[href*="#"], a.w-grid-item-anchor[href*="#"], .w-toplink, ' +
				'.w-blogpost-meta-comments a[href*="#"], .w-comments-title a[href*="#"], a.smooth-scroll[href*="#"]',
			/**
